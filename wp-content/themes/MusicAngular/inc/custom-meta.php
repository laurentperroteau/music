...
add_action("add_meta_boxes", "admin_post");
...
function admin_post(){
    ...
    add_meta_box("fichiers_audio", "Fichiers audio", "fichiers_audio", "post", "normal", "default");
}
...
?>       
      ...
      <input name="fichier_mp3" value="<?php if(!empty($fichier_mp3)) echo $fichier_mp3; ?>" class="dd" style="width: 100%" ></input>
...
function save_detail(){
    ...
    switch($post_type) {
        // If post type page
        case "post":
            update_post_meta($post->ID, "fichier_mp3", $_POST['fichier_mp3']); 
            update_post_meta($post->ID, "fichier_ogg", $_POST['fichier_ogg']); 
            break;
    }  
} //end save_details
